  ...
  <div class="bar-chart">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 800 430" style="enable-background:new 0 0 800 430;" xml:space="preserve">
        <g id="pic_1">
            <g>
                <text transform="matrix(1.046 0 0 1 21.1885 359.7026)" class="st0 st1 st2">0</text>
            </g>
            <g>
                <text transform="matrix(1.046 0 0 1 10.7168 295.8052)" class="st0 st1 st2">10</text>
            </g>
            <g>
                <text transform="matrix(1.046 0 0 1 10.7168 231.9072)" class="st0 st1 st2">20</text>
            </g>
            <g>
                <text transform="matrix(1.046 0 0 1 10.7168 168.0083)" class="st0 st1 st2">30</text>
            </g>
            <g>
                <text transform="matrix(1.046 0 0 1 10.7168 104.1113)" class="st0 st1 st2">40</text>
            </g>
            <g>
...
export default {
  ...
  mounted () {
    //   let bars = document.querySelectorAll('#pic_2 > g')
    //   bars.forEach(function(node){
    //       node.childNodes[0].setAttribute('height', 0)
    //   })
  }
}
</script>
