<template>
  <div class="chart">
    <div class="scrollContent">
      <section  id="pin1" class="chart-background">
...
export default {
  ...
  mounted () {
    ...
    // var scene1 = new ScrollMagic.Scene({triggerElement: "#pin1", duration: 4*h, triggerHook: 0})
    //                 .setPin("#pin1")
    //                 .addTo(controller);
    var stroke1 = document.querySelector('.st8');
    var stroke2 = document.querySelector('.st9');
    var length1 = stroke1.getTotalLength();
    var length2 = stroke1.getTotalLength();
    console.log(length1)
    console.log(length2)
  }
}
