  ...
  <div class="chart2">
	 ...
	 viewBox="0 0 1280 720" style="enable-background:new 0 0 1280 720;" xml:space="preserve">
            ...
            <g id="heat_x5F_island_x5F_chart1_x5F_taipei">
              <polyline :class="lineOneWeb" class="st9" points="172.08,408.5 185.38,377.5 198.67,435.5 211.01,360.5 224.3,435.5 237.59,388.5 249.94,387.5 
            ...
            <g id="heat_x5F_island_x5F_chart1_x5F_tamsui">
              <polyline :class="lineTwoWeb" class="st10" points="173.03,403.5 186.32,407.5 197.72,438.5 211.01,354.5 224.3,427.5 237.59,378.5 249.94,377.5 
            ...
            <g  :class="{'current_group': steps[1] }" class="first_group" id="heat_x5F_island_x5F_chart1_x5F_1985">
              <g>
            ...
            <g class="first_group" id="heat_x5F_island_x5F_chart1_x5F_1985line">
              <g>
                <g>
            ...
            <g :class="groupTwo" class="sec_group" id="heat_x5F_island_x5F_chart1_x5F_2018">
            ...
            <g :class="{'current_group': steps[3] }" class="third_group" id="heat_x5F_island_x5F_chart1_x5F_1980">
              <g>
            ...
            <g  :class="{'current_group': steps[4] }" class="forth_group" id="heat_x5F_island_x5F_chart1_x5F_1986">
              <g>
            ...
            <g  :class="groupFive" class="five_group" id="heat_x5F_island_x5F_chart1_x5F_1987">
              <g>
...
.chart2 {
  ...
  #chart2-background {
    ...
    .chart2-web {
      ...
      .st6{font-size:17.0895px;glyph-orientation-vertical:0;writing-mode:tb;}
    ...
    .line_one_web_step1 {
      animation: redOneWeb 1s linear forwards;
    }
    .line_one_web_step2 {
      animation: redTwoWeb 1s linear forwards;
    }
    ...
    .line_two_web_step1 {
      animation: grayOneWeb 1s linear forwards;
    }
    .line_two_web_step2 {
      animation: grayTwoWeb 1s linear forwards;
    }
